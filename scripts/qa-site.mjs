...
for (const anchor of ['classic-grapes','red-grape-varieties','white-grape-varieties','grapes-in-australia','compare-grapes','all-grape-guides']) if (!header.includes(`href="/grapes/#${anchor}"`)) errors.push(`grape submenu missing #${anchor}`);
