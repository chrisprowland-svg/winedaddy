...
You can learn more about the broader idea of [fermentation](/what-is-fermentation/), [the role of yeast in wine](/what-does-yeast-do-in-wine/) and [malolactic fermentation](/what-is-malolactic-fermentation/). For the wider production sequence, see [how wine is made](/how-wine-is-made/).
...
Alcoholic fermentation produces the principal alcohol in ordinary wine by converting grape sugars into ethanol. This page focuses on that process; alcohol percentages and labelling are covered separately in [alcohol in wine](/alcohol-in-wine/).
...
No. Carbonic maceration is a specialised winemaking process with its own fermentation conditions. It is distinct from this general explanation of alcoholic fermentation. See [carbonic maceration](/carbonic-maceration/) for more.
