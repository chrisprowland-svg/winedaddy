# What Is Carbon Dioxide in Wine? A Beginner’s Guide
...
Alcoholic fermentation is one of the central stages of [how wine is made](/how-wine-is-made/). Yeast feeds on fermentable grape sugars and produces ethanol, carbon dioxide and heat.
...
For a closer look at the process, see [what fermentation means in wine](/what-is-fermentation/) and [what yeast does in wine](/what-does-yeast-do-in-wine/).
...
These methods create different styles, but their shared feature is retained carbon dioxide. You can learn more in the guides to [sparkling wine](/what-is-sparkling-wine/), [traditional-method production](/traditional-method-sparkling-wine-production/), [tank-method production](/tank-method-sparkling-wine-production/) and [ancestral-method production](/ancestral-method-sparkling-wine-production/).
...
For that last distinction, see [sulphur dioxide in wine](/sulfur-dioxide-in-wine/).

Carbon dioxide is also not the same as **carbonic maceration**. Carbonic maceration is a distinct whole-bunch red-winemaking process, not simply wine containing dissolved CO₂. Read more about [carbonic maceration](/carbonic-maceration/) if the terms have become muddled.
...
1. Whether the fizz is brief or continues.
2. Whether the wine tastes unexpectedly sweet.
3. Whether there is unusual pressure when opening the bottle.
4. Whether the aroma and flavour seem sound.
5. Whether the label or producer description suggests a lightly spritzy style.
...
- [How traditional-method sparkling wine is produced](/traditional-method-sparkling-wine-production/)
