...
- aroma and other volatile compounds;
- acidity and sulphur-dioxide composition;
...
- **Conventional filtration:** Usually targets particles, haze or microorganisms. Reverse osmosis is primarily component separation under pressure.
- **Fining:** Uses an added fining agent to react with or adsorb selected compounds. Reverse osmosis uses membrane selectivity.
- **Blending:** Combines wines or fractions to change composition or balance. It does not itself separate molecules, but may follow reverse osmosis.
- **Acid adjustment:** Changes acidity or pH through a specific adjustment. Reverse osmosis may affect acid composition, but it is not principally an acid-adjustment process.
- **Cold stabilisation:** Uses cold conditions to help manage tartrate crystals. It addresses a different stability issue.
- **Dealcoholised-wine production:** Describes the broader product-making objective. Reverse osmosis may be one technology used within it.
- **Vacuum distillation and spinning-cone technology:** These are different separation technologies and should not be used as alternative names for reverse osmosis.

For the wider production journey, see [How Wine Is Made](/how-wine-is-made/). The distinctions between [filtering wine](/filtering-wine/), [fining wine](/fining-wine/), [blending wine](/blending-wine/) and [dealcoholised wine production](/dealcoholised-wine-production/) are especially useful here.
...
- [What Is Acid Adjustment?](/acid-adjustment/)
- [What Is Cold Stabilisation?](/cold-stabilisation/)
