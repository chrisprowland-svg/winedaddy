...
const articles = [
  ...
  ['what-is-pinot-noir', 'What Is Pinot Noir? A Beginner’s Guide to the Red Wine', 'Pinot Noir is a red grape variety known for fresh acidity, red-fruit flavours and often lighter to medium-bodied wines. Learn what it tastes like, whether it is sweet and where it is grown in Australia.', 'Grapes'],
  ['what-is-shiraz', 'What Is Shiraz? A Beginner’s Guide to Australia’s Favourite Red Grape', 'Shiraz is a versatile red wine grape known as Syrah internationally. Learn what Shiraz tastes like, whether it is sweet and how Australian regions shape its style.', 'Grapes'],
  ['what-is-chardonnay', 'What Is Chardonnay? A Beginner’s Guide to Its Flavours and Styles', 'Chardonnay is a versatile white wine grape that can make fresh, citrusy, oaky, creamy, still or sparkling wines. Learn what it tastes like and why styles vary.', 'Grapes'],
  ['what-is-pinot-gris-pinot-grigio', 'What Is Pinot Gris / Pinot Grigio? A Beginner’s Guide', 'Pinot Gris and Pinot Grigio are names for the same grape. Learn why both appear on labels, how the styles can differ and what Australian drinkers should look for.', 'Grapes'],
  ['what-is-sauvignon-blanc', 'What Is Sauvignon Blanc? A Beginner’s Guide to Its Flavour and Style', 'Sauvignon Blanc is a fresh, aromatic white wine grape variety. Learn what it tastes like, whether it is sweet and how Australian styles vary.', 'Grapes'],
  ...
  ['what-is-natural-wine', 'What Is Natural Wine?', 'Natural wine usually means a low-intervention approach, but there is no single universal definition. Learn what the term does and does not tell you.'],
  ['what-is-organic-wine', 'What Is Organic Wine?', 'Learn what organic wine means in Australia, how certification works and why organic does not automatically mean natural, vegan or preservative-free.'],
  ['what-is-biodynamic-wine', 'What Is Biodynamic Wine?', 'Learn how biodynamic wine relates to organic farming, certification and cellar practices, and what the label can and cannot tell you.'],
  ['what-is-merlot', 'What Is Merlot?', 'Merlot is a red grape known for plum and dark-fruit flavours, moderate tannin and a smooth texture. Learn how its styles vary.', 'Grapes'],
  ['what-is-grenache', 'What Is Grenache?', 'Grenache is a versatile red grape known for red fruit, spice and warmth. Learn about its Australian styles, blends and growing regions.', 'Grapes'],
  ['what-is-sangiovese', 'What Is Sangiovese?', 'Sangiovese is an Italian red grape known for bright acidity, savoury character and red-fruit flavours. Learn what to expect in Australian examples.', 'Grapes'],
  ['what-is-nebbiolo', 'What Is Nebbiolo?', 'Nebbiolo is a pale-coloured but structured red grape known for high acidity, firm tannin and complex aromas. Learn how to approach it.', 'Grapes'],
  ['what-is-tempranillo', 'What Is Tempranillo?', 'Tempranillo is a Spanish red grape that can make juicy young wines or complex oak-aged styles. Learn what Australian drinkers should expect.', 'Grapes'],
  ['how-to-taste-wine', 'How to Taste Wine', 'A practical step-by-step guide to looking, smelling and tasting wine without the theatre.'],
  ['what-is-fermentation', 'What Is Fermentation in Wine?', 'Fermentation is the process in which yeast converts grape sugar into alcohol, carbon dioxide and flavour compounds. Learn how it shapes wine.', 'Winemaking'],
  ['what-does-oak-do-to-wine', 'What Does Oak Do to Wine?', 'Learn how oak can influence wine flavour, aroma, texture and ageing, and why not every oaked wine tastes the same.', 'Winemaking'],
  ['what-is-terroir', 'What Is Terroir?', 'Terroir describes how place, climate, site, soil, vine and people interact to shape wine. Learn what the term usefully means.', 'Winemaking'],
  ['how-climate-affects-wine', 'How Climate Affects Wine', 'Learn how temperature, sunlight, rainfall and seasonal conditions influence grape ripeness, acidity, flavour and wine style.', 'Winemaking'],
  ['wine-serving-temperature-explained', 'Wine Serving Temperature Explained', 'Learn practical serving temperatures for red, white, sparkling and fortified wine, and how temperature changes aroma, flavour and texture.'],
  ['when-to-decant-wine', 'When Should Wine Be Decanted?', 'Learn when decanting can help wine, when it may do little, and how to decant young, old and sediment-bearing bottles safely.'],
  ['how-to-store-open-wine', 'How to Store an Open Bottle of Wine', 'Learn how refrigeration, resealing and reduced oxygen exposure can keep an opened bottle tasting fresh for longer.'],
  ['how-to-cellar-wine', 'How to Cellar Wine', 'A practical guide to temperature, light, humidity, vibration and bottle position for storing wine safely at home.'],
  ['what-is-cork-taint', 'What Is Cork Taint?', 'Cork taint can mute fruit and create musty aromas. Learn how to recognise it, what causes it and what to do with an affected bottle.'],
  ['what-is-oxidation-in-wine', 'What Is Oxidation in Wine?', 'Learn how oxygen can help or harm wine, how oxidation tastes and smells, and when oxidative character is intentional rather than a fault.'],
  ['how-to-read-a-wine-label', 'How to Read a Wine Label', 'Learn how to find the producer, region, grape, vintage, alcohol and other useful clues on an Australian wine label.'],
];
...
for (const [slug, title, description, articleSection = 'Wine fundamentals'] of articles) {
  ...
  if (/^(?:BEGIN|END) READER ARTICLE\s*$/im.test(md)) {
    throw new Error(`${slug}: internal reader-article boundary marker reached the public source`);
  }
  ...
  if (/<h[1-3][^>]*>\s*(?:References|Claim-to-Source Notes|Unresolved Flags)\s*<\/h[1-3]>|INTERNAL EDITORIAL APPENDIX|NOT FOR PUBLICATION|IMPLEMENTATION NOTE|(?:BEGIN|END) READER ARTICLE|<(?:strong|b)>\s*(?:Canonical (?:URL|route)|Article type|Last (?:reviewed|updated|researched)):/i.test(body)) {
