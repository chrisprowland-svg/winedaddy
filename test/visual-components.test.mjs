...
test('keeps the reconciled visual rollout complete and production notes private', () => {
  ...
  assert.equal(markers.length,239);
  assert.equal(new Set(markers.map(match=>match[1])).size,63);
